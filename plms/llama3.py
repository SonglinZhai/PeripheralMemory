...
from .phi3 import is_torchdynamo_compiling, StaticCache
...
class LlamaAttention(nn.Module):
    ...
    def forward(
        ...
        **kwargs,
        ...
        query_states, key_states = apply_rotary_pos_emb(query_states, key_states, cos.to(self.q_proj.weight.device), sin.to(self.q_proj.weight.device))
...
class LlamaFlashAttention2(LlamaAttention):
    ...
    def forward(
        ...
        if position_embeddings is None:
            ...
            cos, sin = position_embeddings
        query_states, key_states = apply_rotary_pos_emb(query_states, key_states, cos.to(hidden_states.device), sin.to(hidden_states.device))
...
class LlamaModel(LlamaPreTrainedModel):
    ...
    def forward(
        ...
        **kwargs,
        ...
        if cache_position is not None: cache_position = cache_position.to(inputs_embeds.device)
        ...
        for i, decoder_layer in enumerate(self.layers):
            ...
            # position_embedding is placed into corresponding device in the LlamaAttention class
    ...
    def disperse_to_gpus(self, layers_gpus_alloc_config:dict):
        ...
        if input_device is not None:
            ...
            self.rotary_emb = self.rotary_emb.to('cuda:'+str(input_device))
